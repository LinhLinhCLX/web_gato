...
Route::get('bai-viet/{slug}', 'client\BlogController@getBlogDetail')->name('client.blog.detail');
...
// Cart
Route::get('gio-hang', 'client\CartController@getDetailsCart')->name('details.cart');
Route::get('them-gio-hang/{id_product}', 'client\CartController@getAddToCart')->name('add.to.cart');
Route::get('sua-gio-hang/{id_product}', 'client\CartController@getUpdateCart')->name('update.to.cart');
Route::get('xoa-gio-hang/{id_product}', 'client\CartController@getDeleteCart')->name('delete.to.cart');
Route::get('check-out','client\CartController@getCheckOut')->name('check.out');
Route::post('thanhtoan','client\CartController@postCheckOut')->name('check.out.post');
...
// Route backend
Route::prefix('cms-admin')->middleware('CheckPermission')->group(function(){
	...
	Route::prefix('order')->group(function(){
		...
		Route::get('/details/{id_order}', 'admin\OrderController@getDetailsOrder')->name('order.details');
		//Đơn mới
		//
		//Đơn đã xử lý
