    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active"><a href="{{route('client.product.list')}}">Sản phẩm</a></li>
                @if($cate_product != null)
                <li class="active"><a href="{{route('client.product.list.cate_product', ['slug'=>$cate_product->slug])}}">{{$cate_product->name}}</a></li>
                @endif
            </ul>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-9 order-1 order-lg-2">
                ...
                <div class="single-banner shop-page-banner">
                    <a href="#">
                        <img src="https://media.istockphoto.com/vectors/bakery-banner-for-pastry-products-or-confectionery-vector-id1058637072" alt="cake">
                    </a>
                </div>
