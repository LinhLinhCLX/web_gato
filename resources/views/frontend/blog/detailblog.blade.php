                    ...
                    <div class="col-lg-12">
                        <div class="li-blog-single-item pb-30">
                            <div class="li-blog-banner">
                                <a href="{{route('client.blog.detail', ['slug'=> $blog->slug])}}"><img class="img-full" src="assets/img_blog/{{$blog->image}}" alt="{{$blog->name}}"></a>
                            </div>
                            <div class="li-blog-content">
                                <div class="li-blog-details">
                                    <h3 class="li-blog-heading pt-25"><a href="{{route('client.blog.detail', ['slug'=> $blog->slug])}}">{{$blog->name}}</a></h3>
                                    <div class="li-blog-meta">
                                        <a class="author" href="#"><i class="fa fa-user"></i>{{$blog_admin->name}}</a>
                                        {{--<a class="comment" href="#"><i class="fa fa-comment-o"></i> 3 comment</a>--}}
                                        <a class="post-time" href="#"><i class="fa fa-calendar"></i> {{$blog->created_at}}</a>
                                    </div>
