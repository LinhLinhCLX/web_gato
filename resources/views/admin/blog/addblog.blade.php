...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="{{route('blog.list')}}" class="active">Thêm Bài viết</a> </li>
	</ul>
	<hr>
    <div>
            @if(count($errors) > 0)
...
<div class="col-xs-12 col-md-12 col-lg-12">
    <div class="panel panel-primary">
        <div class="panel-heading" style="font-size:16px">Thêm Bài viết</div>
        <div class="panel-body">

        	<form role="form" action="{{route('blog.add.post')}}" method="post" enctype="multipart/form-data">
        		@csrf
	                ...
	                <div class="col-md-12">
	                    <div class="form-group">
	                        <div class="form-group">
								...
								<textarea placeholder="Nhập Tóm tắt bài viết" name="short_description" id="content1"></textarea>
	                        </div>
	                    </div>
					</div>
					<div class="col-md-12">
	                    <div class="form-group">
	                        <div class="form-group">
								...
								<textarea placeholder="Nhập Nội dung bài viết" name="full_description" id="content2"></textarea>
	                        </div>
	                    </div>
					</div>
	        	</div>
